...
namespace JoeMidi1
{
    public class SimpleMapping : Mapping
    {
        ...
        override public void bind(Dictionary<String, LogicalInputDevice> logicalInputDeviceDict, Dictionary<String, SoundGenerator> soundGenerators, String JoeMidiDirectory)
        {
            ...
            base.bind(logicalInputDeviceDict, soundGenerators, JoeMidiDirectory);
        }
    }
}
